...
import Ojolakisian1 from "../assets/Ojolakisian1.jpg";
 ...
 const projects = [
    ...
    },
    {
      ...
      image: kenyaVilla,
      description:
        " This is a ready-to-run investment with consistent rental income potential in a growing educational hub.  Located Off Chwele–Bungoma Road,  Marakaru/Tuuti Ward,  Kanduyi Constituency, Bungoma County, Western Kenya.  Conveniently located just 1.2 kilometres from Kibabii University, making it an ideal student accommodation investment. It sits on a 50 by 100 feet titled plot with 22 single hostel rooms sharing external bathrooms and toilets. The Income potential is rent per room at 2500, and a total of  220,000 Kenya shillings per semester. The facility has;  Electricity connected, Reliable borehole water supply &  harvested Rain Water,  Secure gated compound with a perimeter stone wall fence.",
      features: [
        "Electricity connected",
        "Reliable borehole water supply & harvested Rain Water",
        "Secure gated compound with a perimeter stone wall fence",
        "Staff Quarters",
      ],
    },
    {
