          ...
          >
            <div>
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Kenya’s real estate sector is projected to grow from $733.4 billion in 2024 to $944.1 billion
                  by 2029, driven by rapid urbanization, a growing middle class, and high demand for affordable 
                  housing (exceeding 250,000 units annually).
                </p>
                <p>
                  With the government expressing unwavering commitment to continuous investment on social 
                  infrastructural projects across the country including expanding major roads and highways
                  as well as rail and water transport, demand for land both for residential and commercial 
                  purposes is only expected to increase in the medium term. 
                </p>
                <p>
                  BeaconTrust was founded in 2025 to provide services that fit within this rapidly expanding 
                  sector. We are a Kisumu-based private real estate firm offering end-to-end services grounded 
                  in professionalism, integrity, and accountability.
                </p>
              </div>
            </div>
